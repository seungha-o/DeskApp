				...
				<div class="col-md-6 col-lg-5">
					<div class="login-box bg-white box-shadow border-radius-10">
						<div class="login-title">
							<img src="./resources/vendors/images/wefer2.png" alt="" class="light-logo">
						...
						<form action="login.do" method="post">
							...
							<div class="input-group custom">
								<input name="id" type="text" class="form-control form-control-lg" placeholder="Username">
							...
							<div class="row pb-30">
								...
								<div class="col-6">
									<div class="forgot-password"><a href="forgot-password.html">비밀번호 찾기</a></div>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-12">
