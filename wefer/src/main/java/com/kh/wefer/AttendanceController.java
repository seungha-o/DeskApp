...
//		java.util.Date utilDate = rs.getTimestamp("regdate");    
	...
	@RequestMapping("/myattendance.do")
	public ModelAndView myattendance(ModelAndView mv,HttpSession session) throws ParseException {
...
//		java.util.Date utilDate = rs.getTimestamp("regdate");    
		...
		mv.addObject("list",list);
		mv.setViewName("attendance/myattendance");
		return mv;	
	}
